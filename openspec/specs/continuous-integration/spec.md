...
## Purpose
What the project checks on its own, without being asked: which suites run on a
change, what has to pass before it merges, and the rule that the artifact which
