# Developing TypeLearn

How to run the stack locally, test it, debug it, and work in several worktrees at once.
For installing it on a real cluster, see [deployment.md](deployment.md).
...
fixed by the debug setting any more; see [What serves what](deployment.md#what-serves-what).
